...
const zhCN: Dictionary = {
  ...
  "conditionalFormat.valueSource": "比较值",
  "conditionalFormat.target": "格式目标",
  "conditionalFormat.targetField": "目标属性",
  "filter.field": "属性",
  "filter.operator": "运算符",
  "conditionalFormat.literal": "指定值",
  "conditionalFormat.today": "今天",
...
const zhTW: Dictionary = {
  ...
  "conditionalFormat.valueSource": "比較值",
  ...
  "modal.preset": "預設",
  "modal.propertyKey": "屬性名",
  "modal.propertyKeyExists": "屬性「{key}」已存在",
  "modal.propertyKeyHint": "對應筆記 frontmatter 中的 property key",
  "modal.propertyKeyRequired": "屬性名不能為空",
