...
const en: Dictionary = {
  ...
  "viewConfig.computedCleanup.title": "Clear saved formula property",
  "viewConfig.computedCleanup.desc": "Choose one formula property to remove from note frontmatter in this database scope. This does not delete the formula column. If automatic saving is enabled, it will switch to display-only first so the property is not recreated.",
  "viewConfig.computedCleanup.confirm": "Clear property",
  "viewConfig.computedCleanup.noFields": "No formula fields are available to clean up.",
  "viewConfig.computedCleanup.optionField": "Formula field: {label}",
  "viewConfig.computedCleanup.optionKey": "Saved frontmatter property: {key}",
...
const zhCN: Dictionary = {
  ...
  "viewConfig.computedCleanup.desc": "选择一个要从当前数据库范围内笔记 frontmatter 中移除的计算属性。这不会删除公式列。如果当前开启了自动保存，会先切换为仅显示，避免属性被重新写回。",
  "viewConfig.computedCleanup.confirm": "清理属性",
  "viewConfig.computedCleanup.noFields": "没有可清理的计算字段。",
  "viewConfig.computedCleanup.optionField": "计算字段：{label}",
  "viewConfig.computedCleanup.optionKey": "将清理 frontmatter 属性：{key}",
...
const zhTW: Dictionary = {
  ...
  "viewConfig.computedCleanup.desc": "選擇一個要從目前資料庫範圍內筆記 frontmatter 中移除的計算屬性。這不會刪除公式欄。如果目前開啟了自動儲存，會先切換為僅顯示，避免屬性被重新寫回。",
  "viewConfig.computedCleanup.confirm": "清理屬性",
  "viewConfig.computedCleanup.noFields": "沒有可清理的計算欄位。",
  "viewConfig.computedCleanup.optionField": "計算欄位：{label}",
  "viewConfig.computedCleanup.optionKey": "將清理 frontmatter 屬性：{key}",
